...
function About({ onMobile }) {
  ...
  useEffect(() => {
    ...
    if (showPicture) {
      ...
      tl.current.to("#emptyPolaroid", .5, { opacity: 0 }, "<1")
      ...
      .to("#photo", 2, { opacity: .25, filter: "grayscale(.75) blur(1.5px)" })
      .to("#photo", 5, { opacity: 1, filter: "grayscale(0) blur(0px)", })
    } else {
      tl.current.pause()
      gsap.to("#emptyPolaroid", .1, { backgroundColor: "#000", opacity: 1 })
    ...
    <section className={styles.section}>
      ...
      <div className={styles.headingFlexContainer}>
        ...
        >
          ...
          <Camera onMobile={onMobile} setShowPicture={setShowPicture} isDarkMode={isDarkMode} />
      ...
      <div className={styles.aboutFlexContainer}>
        <div className={styles.textContainer}>
          ...
          <p className={styles.text}>
            ...
            two years, and now, I'm finally able to return home and start applying for jobs.
          </p>
          <br />
          <p className={styles.text}>
            I've lived abroad for a while, and I suppose that's come to somewhat define a
            part of who I am. But, my wife and I have decided to move
