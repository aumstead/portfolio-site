import styles from './DgiFolios.module.scss'

function DgiFoliosSvg() {
  return (
<svg className={styles.logo} width="29" height="32" viewBox="0 0 29 32" fill="none" xmlns="http://www.w3.org/2000/svg">
