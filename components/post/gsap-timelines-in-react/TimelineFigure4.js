...
function TimelineFigure4({ onMobile }) {
  ...
  useEffect(() => {
    ...
    myTimeline.current
      ...
      .to("#red-icon-group6", { duration: .2, x: 45 }, "<")
      .to("#green-icon-group6", { duration: .2, y: -48 })
      .to("#blue-icon-group6", { duration: .2, y: 48 })
      .to("#yellow-icon-group6", { duration: .2, y: -48 })
...
export default TimelineFigure4;
