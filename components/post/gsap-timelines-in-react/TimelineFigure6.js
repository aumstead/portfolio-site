...
function TimelineFigure6({ onMobile }) {
  ...
  useEffect(() => {
    ...
    myTimeline.current
      ...
      .to("#red-icon-group8", { duration: .2, x: 45 }, "<")
      .to("#green-icon-group8", { duration: .2, y: -48 }, "<")
      .to("#blue-icon-group8", { duration: .2, y: 48 }, "<.2")
      .to("#yellow-icon-group8", { duration: .2, y: -48 }, "<")
...
export default TimelineFigure6;
