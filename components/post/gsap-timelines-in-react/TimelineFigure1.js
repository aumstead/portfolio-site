...
function TimelineFigure1({ onMobile }) {
  ...
  useEffect(() => {
    ...
    myTimeline.current
      ...
      .to("#red-icon-group3", { duration: 1, x: 45 })
      .to("#green-icon-group3", { duration: 1, y: -48 })
...
export default TimelineFigure1;
