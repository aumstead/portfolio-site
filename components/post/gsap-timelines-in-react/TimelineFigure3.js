...
function TimelineFigure3({ onMobile }) {
  ...
  useEffect(() => {
    ...
    myTimeline.current
      ...
      .to("#red-icon-group5", { duration: 1, x: 45 }, "<")
      .to("#green-icon-group5", { duration: 1, y: -48 })
      .to("#blue-icon-group5", { duration: 1, y: 48 })
      .to("#yellow-icon-group5", { duration: 1, y: -48 })
...
export default TimelineFigure3;
