...
function TimelineFigure2({ onMobile }) {
  ...
  useEffect(() => {
    ...
    myTimeline.current
      ...
      .to("#red-icon-group4", { duration: 1, x: 45 })
      .to("#green-icon-group4", { duration: 1, y: -48 })
...
export default TimelineFigure2;
